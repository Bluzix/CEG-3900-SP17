...
import edu.wright.ceg3900.db.SudokuDatabase;
import edu.wright.ceg3900.game.SudokuGame;
import edu.wright.ceg3900.game.SudokuGame.OnPuzzleSolvedListener;
import edu.wright.ceg3900.gui.inputmethod.IMControlPanel;
import edu.wright.ceg3900.gui.inputmethod.IMControlPanelStatePersister;
import edu.wright.ceg3900.gui.inputmethod.IMNumpad;
import edu.wright.ceg3900.gui.inputmethod.IMPopup;
import edu.wright.ceg3900.gui.inputmethod.IMSingleNumber;
...
public class SudokuPlayActivity extends Activity {
	...
	public static final int MENU_ITEM_ABOUT = Menu.FIRST + 5;
	...
	// the long for the Blank01 puzzle
	private long mSudokuGameID = 1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			// TODO: Here's where I'll have to read FireBase for later
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_ITEM_ABOUT, 8, R.string.about)
				.setShortcut('2', 'i')
